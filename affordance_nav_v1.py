...
def main():
    ...
    for e, p_input in enumerate(planner_inputs):
        ...
        if args.visualize or args.print_images:
            ...
            local_map[e, -2, :, :] = 1e-5
            p_input['sem_map_pred'] = local_map[e, 4:-1, :, :
                                      ].argmax(0).cpu().numpy()
        ...
        if args.visualize or args.print_images:
            ...
            p_input['sem_map_pred'] = local_map[e, 4:-1, :,
                                          :].argmax(0).cpu().numpy()
            p_input['attr_map']=local_map[e, -1, :,:].cpu().numpy()
        if NEW_EPISODE_C[e] < 16:
            p_input['init_rotate_flag'] = 1
    ...
    for step in range(args.num_training_frames // args.num_processes + 1):
        ...
        if l_step == args.num_local_steps - 1:
            ...
            for e in range(num_scenes):
                ...
                target_edge_map[e], target_point_map[e], Goal_score = remove_small_points(_local_ob_map, target_edge, 4,
                                                                                          local_pose_map)
        ...
        for e, p_input in enumerate(planner_inputs):
            ...
            p_input['wait'] = wait_env[e] or finished[e]
            p_input['NEW_EPISODE_C'] = NEW_EPISODE_C[e]
            if args.visualize or args.print_images:
                p_input['map_edge'] = target_edge_map[e]
                local_map[e, -2, :, :] = 1e-5
                p_input['sem_map_pred'] = local_map[e, 4:-1, :,
