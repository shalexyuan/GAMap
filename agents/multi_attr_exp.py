...
class Multi_Attr_Exp_Env_Agent(ObjectGoal_Env21):
    ...
    def reset(self):
        ...
        goal=info['goal_name']
        # self.goal_attributes=[cat_2_multi_att_prompt[goal]]
        self.goal_attributes=cat_2_multi_att_prompt[goal]
    ...
    def _preprocess_obs(self, obs, use_seg=True):
        ...
        #     rgb.astype(np.uint8), depth, use_seg=use_seg)
        scores = []
        for att in self.goal_attributes:
            scores.append(score_map[att][..., None])
        ...
        state = np.concatenate((rgb, depth, sem_seg_pred,scores),
